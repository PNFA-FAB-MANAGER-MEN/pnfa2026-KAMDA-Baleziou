...
3. **Découpe Laser :**
  ...
  - Consignes de sécurité : Interdiction stricte de découper des matériaux poreux ou plastiques toxiques (ex. PVC).
    ...
    - Exemple d'une découpeuse laser xTool ouverte dans un atelier de fabrication numérique : sa tête laser est montée sur l'axe, en haut à gauche, au-dessus d'une plaque de contreplaqué posée dans la zone de travail. La machine réalise la découpe de formes et de prénoms ; aucune inscription lisible n'est visible sur l'image. L'ensemble illustre une démonstration technique et pratique. ![Découpeuse laser xTool ouverte, tête laser au-dessus d'une plaque de contreplaqué dans la zone de travail](C:/Users/zoulou/Desktop/FABMANAGER/decoupe-laser-T3%20xtool.jpeg)
