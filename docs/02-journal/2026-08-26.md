...
3. **Découpe Laser :**
  ...
  - Consignes de sécurité : Interdiction stricte de découper des matériaux poreux ou plastiques toxiques (ex. PVC).
     ...
     ![DecoupelaserT3xtool](image.png) le matériau est une plaque de contreplaqué posée dans la zone de travail. Le travail réalisé est la découpes des formes et des prénoms.
